// ===== TAMBOLA TICKET ENGINE (pure logic, no DOM) =====
// Shared by tickets.html (js/tickets.js) and the home-page demo (js/home.js).
// All functions are global on purpose — this project uses classic scripts.
